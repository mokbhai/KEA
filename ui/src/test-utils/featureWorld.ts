...
export function featureHandlers({
  ...
  return {
    ...
    list_input_devices: () => [
      { id: "MacBook Air Microphone", name: "MacBook Air Microphone", is_default: true },
      { id: "Yeti", name: "Yeti", is_default: false },
    ],
    start_input_preview: () => undefined,
    stop_input_preview: () => undefined,
